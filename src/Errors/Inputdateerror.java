 ...
 * @author Dinuka
 */
public class Inputdateerror extends javax.swing.JDialog {

    /**
     * Creates new form dbError
     */
    
    public Inputdateerror() {
        initComponents();
    }
    
    public Inputdateerror(String theme, String msg) {
        super((Window)null);
        setModal(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        theme.setText("User input is wrong");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inputdateerror.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
